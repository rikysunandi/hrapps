...
class Ion_auth_model extends CI_Model {
    ...
    public function login($identity, $password, $remember = FALSE) {
       ...
       /* $query = $this->db->select($this->identity_column . ', email, id, password,username,company,first_name,last_name, active, last_login,kode_vendor')
                ->where($this->identity_column, $identity)
                ->limit(1)
                ->order_by('id', 'desc')
                ->get($this->tables['tb_users']);*/
		
		$query = $this->db->query("SELECT `username`, `email`, `id`, `password`, `username`, `company`, `first_name`, `last_name`, `active`, `last_login`, `kode_vendor`, `company`
				FROM `tb_users`
