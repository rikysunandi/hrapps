<section class='content-header'>
    <h1>
        Distribusi
        <small>Monitoring Lead Measure</small>
    </h1>
    <ol class='breadcrumb'>
        <li><a href='#'><i class='fa fa-suitcase'></i>Distribusi</a></li>
        <li class='active'>Monitoring Lead Measure</li>
    </ol>
</section>     
...
<script>    
    $(document).ready(function(){  
		...
		"ajax": {
                        "url": '<?php echo site_url('distribusi_new/view_mon_lead_measure'); ?>',
                        "type": "POST",
            ...
            <div class="modal-body form">
               <form class="form-horizontal" method="post" action="<?php echo base_url().'Distribusi/update_pencapaian_lm'?>">
                    <div class="form-body">
                        ...
                        <div class="col-xs-9">
                            <input name="pencapaian"  id="pencapaian" class="form-control" type="text" 
							placeholder="pencapaian..." style="width:335px;" required>
                        </div>
						</div>
