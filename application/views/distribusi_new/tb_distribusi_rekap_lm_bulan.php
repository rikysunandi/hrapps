<section class='content-header'>
    <h1>
        Distribusi
        <small>Rekap Lead Measure Per Bulan</small>
    </h1>
    <ol class='breadcrumb'>
        <li><a href='#'><i class='fa fa-suitcase'></i>Distribusi</a></li>
        <li class='active'>Rekap Lead Measure Per Bulan</li>
    </ol>
</section>     
...
<script>    
    $(document).ready(function(){  
        ...
        "Processing": true, 
        "ServerSide": true,
        "lengthMenu": [[150, 50, 25, -1], [150, 50, 25, "All"]], 
		dom:
		...
		"ajax": {
                        "url": '<?php echo site_url('Distribusi_new/view_rekap_lead_measure_bulan'); ?>',
                        "type": "POST",
	...
	<div class="box box-primary">
        <div class="box-header with-border">
		  <div class="user-block">
                <img class="img-square" src="<?php echo base_url('assets/img/month.png'); ?>" alt="User Image">
                <span class="username"><a href="#">Rekap LM</a></span>
              </div>
        ...
        <div class="box-footer">
		  ...
		  <div class="col-md-10">
            <div class='box box-primary'>  
                ...
                <span class="username"><a href="#">Rekap Lead Measure Perbulan</a></span>
              </div>
					</div>
                </div><!-- /.box-header -->		
				<div class='box-header with-border'>
                    ...
                    <table class="table table-bordered table-striped" id="mytable" width="100%">
                        <thead>
							<tr>
										...
										<th colspan="6" class="text-center">P2TL</th>
										<th colspan="6" class="text-center">PERGANTIAN METER</th>
										<th colspan="6" class="text-center">PLG POTENSIAL</th>
										<!--th colspan="2" bgcolor="#00FFFF" class="text-center">PLN KEU</th-->
							</tr>
							<tr>
										<!--th colspan="2" class="text-center"><button class="btn btn-info" id="btn_proses">proses tagihan</button></th-->
										<th colspan="3" class="text-center"></th>
										<th colspan="3" class="text-center">PLG</th>
										<th colspan="3" class="text-center">kWh</th>
