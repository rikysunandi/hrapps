...
<script>    
    $(document).ready(function(){  
		...
		"ajax": {
                        "url": '<?php echo site_url('Distribusi/view_lead_measure'); ?>',
                        "type": "POST",
		...
		var id=$(this).val();
		$.ajax({
        url: '<?php echo site_url('general/GetSubLm_by'); ?>',
		data : {idwig:id},
		type: 'POST',
        success: function(data) {
...
<div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Cari Data Lead Measure</h3>
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-3">
              ...
              <!-- /.form-group -->
             <div class="form-group">
                <label>SUB LEAD MEASURE</label>
                <select name="id_lm" id="id_lm" class="form-control" > 
                                        <option value="">- Pilih SUB LM -</option>  
                                    </select>         
              </div>
              <!-- /.form-group -->
            </div>
		...
		<button class="btn btn-success btn-md" id="btn_cari">Cari Data</button>
		</span>
        </div>
      </div>
	<div class='row'>	  
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <form method="post" action="<?php echo base_url().'Distribusi/tambah_lm'?>" id="form" class="form-horizontal">
                    <div class="form-body">
...
<div class="modal fade" id="modal_edit" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body form">
               <form class="form-horizontal" method="post" action="<?php echo base_url().'Distribusi/update_pencapaian_lm'?>">
                    <div class="form-body">
						<div class="box box-info">
						<div class="box-header with-border">
						<div class="form-group">
...
function edit_lm(id)
    ...
    $.ajax({
        url : "<?php echo site_url('Distribusi/view_lm_id/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {  	
