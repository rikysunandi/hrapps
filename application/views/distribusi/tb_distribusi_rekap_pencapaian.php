...
<script>    
    $(document).ready(function(){  
		...
		$('#btn_cari').on('click',function(){
			...
			tampil_data_barang(id_wig,id_lm,unitpln,unitpln2,tglpilih);

		});
		
		function tampil_data_barang(id_wig,id_lm,unitpln,unitpln2,tglpilih){
		...
		"ajax": {
                        "url": '<?php echo site_url('distribusi/view_rekap_pencapaian_lead_measure'); ?>',
                        "type": "POST",
						data : {id_wig:id_wig, id_lm:id_lm, unitpln:unitpln, unitpln2:unitpln2, tglpilih:tglpilih},
						complete: function() {
							},
						/*success: function() {
							loadout();
		...
		data : {idwig:id,bidang:'DISTRIBUSI'},
		type: 'POST',
    ...
    <div class='row'>
        <div class='col-xs-12'>
            <div class='box box-primary'>  
			    ...
			    <div class="col-md-2">
							<div class='form-group'>WIG <?php echo form_error('id_unitpln') ?>
				...
				<div class='col-md-3'>
				PENCAPAIAN (PERSEN) : 
				<span class='label label-success'><i class='fa fa-star fa-fw'></i></span> >=100
				</div>
				<div class='col-md-2'>
				<span class='label label-info'><i class='fa fa-check fa-fw'></i></span> >= 70 | < 100
				</div>
				<div class='col-md-2'>
				<span class='label label-warning'><i class='fa fa-sort-asc fa-fw'></i></span> >= 30 | <= 69
				</div>
				<div class='col-md-2'>
				<span class='label label-default'><i class='fa  fa-arrows-h fa-fw'></i></span> >= 1 | <= 29
				</div>
				<div class='col-md-2'>
				<span class='label label-danger'><i class='fa fa-times fa-fw'></i></span> 0
				</div>
				</div>
